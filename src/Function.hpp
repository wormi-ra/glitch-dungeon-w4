...
class Function<R(Args...)>
{
    ...
    template <>
    R invoke_fn(std::nullptr_t*, Args&&...)
    {
        return;
    }
...
public:
    ...
    explicit operator bool() const noexcept {
        return static_cast<bool>(this->data_ptr);
    }
...
template <typename R, typename... Args>
inline bool operator==(const Function<R(Args...)> &__f, std::nullptr_t) noexcept
...
template <typename R, typename... Args>
inline bool operator==(std::nullptr_t, const Function<R(Args...)> &__f) noexcept
{ return !static_cast<bool>(__f); }
